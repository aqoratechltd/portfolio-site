          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              >
                ...
                <MagneticButton
                  onClick={() => window.open(waUrl(service.title), "_blank")}
                  className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl text-white font-medium text-sm bg-[#25D366] hover:bg-[#1ebe5d] transition-colors leading-none"
                >
                  <svg viewBox="0 0 24 24" className="w-4 h-4 flex-shrink-0 translate-y-0" fill="currentColor" aria-hidden="true">
